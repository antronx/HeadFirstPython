...
app.secret_key = 'YouWillNeverGuessThisSuperSecuredKey'
...
def do_search() -> 'html':
    ...
    def log_request(req: 'flask_request', res: str) -> None:
        sleep(15)  # This makes logging requests really slow
...
def view_the_log() -> 'html':
    ...
    try:
        ...
        print('Is your database running? Error: ',str(err))
    except CredentialsError as err:
        print('Login/Password is incorrect. Error: ',str(err))    
